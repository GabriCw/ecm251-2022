public class App {
    public static void main(String[] args) throws Exception {
        Produto cornDog = new Comida(12.5, "Corn Dog", 5,
         "Um cachorro quente meio errado", EnumCategoriaComida.COREANA, 
         EnumAlergicos.GLUTEM, EnumPimenta.SUAVE);

        Produto acaiMoleza = new Bebida(10.5, "Açai do Moleza",
         1, "Real fonte de energia", EnumCategoriaBebida.SUCO,
